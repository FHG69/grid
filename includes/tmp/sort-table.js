...
sortTable.init = function() {
    ...
    sheet.insertRule('table.js-sort-table.js-sort-asc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25b2";position:relative;top:-3px;font-size: 0.7em;float:right;padding-left: 2px;line-height: 0.7em;}', 0);
    sheet.insertRule('table.js-sort-table.js-sort-desc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25bc";position:relative;top:-3px;font-size: 0.7em;float:right;padding-left: 2px;line-height: 0.7em;}', 0);
};
